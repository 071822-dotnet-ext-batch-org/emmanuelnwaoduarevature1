    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (player1Name.Length > 15){
              ...
              Console.WriteLine($"Name cannot be more than 15 characters");
               player1Name = Console.ReadLine();
            }
            ...
            while (true)
            {
                ...
                while (isTie)
                {
                                    ...
                                    (player1Choice == 3 && computerChoice == 2))
                    {
                        ...
                        isTie = false;
                        Console.WriteLine($"This is {player1Name}'s number {player1wins} win For round number {rounds}.");
                        Console.WriteLine();
                    ...
                    {// if the computer won
                        ...
                        isTie = false;
                       Console.WriteLine($"This is {computerName}'s number {computerWins} win For round number {rounds}.");
                       Console.WriteLine();
                    }
                }
                if(rounds < 3){
                ...
                isTie = true;
                    ...
                    if(player1wins > computerWins){
                        Console.WriteLine();
                        Console.WriteLine($"CONGRATS, {player1Name}, you won this game by {player1wins} to {computerWins} against {computerName}.");
                    }
                    else{
                       Console.WriteLine();
                       Console.WriteLine($"CONGRATS, {computerName}, you won this game by {computerWins} to {player1wins} against {player1Name}.");
                    }
